...
<%@ page import="com.huiaicharity.entity.Activities" %>
        ...
        <form action="addactivityservlet" method="post">
            <table border="4" align="center" width="100%" height="70%">
                ...
                <tr>
                    ...
                    <td><input type="text" name="address" PLACEHOLDER="活动地点" /></td>
                ...
                <% ArrayList<Activities> activitylist= (ArrayList<Activities>) session.getAttribute("activitylist");
                    for(int i=0;i<activitylist.size();i++){ Activities p=activitylist.get(i); %>
                <tr>
                    <td>
                        <%=p.getActid()%>
                    </td>
                    ...
                    <td><a class="edit"
                           href="<%=request.getContextPath()%>/editActivity.jsp?actid=<%=p.getActid()%>">编辑</a>
                    </td>
                    <td><a class="del"
                           href="<%=request.getContextPath()%>/delactivityservlet?actid=<%=p.getActid()%>">删除</a>
                    </td>
                </tr>
                <% } %>
            </table>
